<?php
/**
 * Script to update parents table schema
 * Run this file once from browser: http://localhost/School/backend/run_parent_table_update.php
 * Or from command line: php run_parent_table_update.php
 */
...
$sql_file = __DIR__ . '/database/alter_parents_table.sql';
...
if ($error_count === 0) {
    ...
    echo "<p><strong>NOTE:</strong> You can now delete this file (run_parent_table_update.php) as it's no longer needed.</p>";
} else {
