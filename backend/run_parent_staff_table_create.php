<?php
/**
 * Script to create parent_staff table
 * Run once via browser: http://localhost/School/backend/run_parent_staff_table_create.php
 * Or CLI: php run_parent_staff_table_create.php
 */
...
$sql_file = __DIR__ . '/database/create_parent_staff_table.sql';
...
if ($error_count === 0) {
    ...
    echo "<p><strong>NOTE:</strong> You can now delete this file (run_parent_staff_table_create.php) as it's no longer needed.</p>";
} else {
